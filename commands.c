...
/*   Updated: 2025/04/08 13:25:51 by ldevoude         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (keycode == 1 && param->mandelbrot)
		param->c->real_x -= param->zoom / 4;
	if (keycode == 2 && param->mandelbrot)
		param->c->imaginary_y -= param->zoom / 4;
	if (keycode == 3 && param->mandelbrot)
		param->c->real_x += param->zoom / 4;
	if (keycode == 4 && param->mandelbrot)
		param->c->imaginary_y += param->zoom / 4;
	if (keycode == 1 && param->mandelbrot == FALSE)
		param->z->real_x -= param->zoom / 4;
	if (keycode == 2 && param->mandelbrot == FALSE)
		param->z->imaginary_y -= param->zoom / 4;
	if (keycode == 3 && param->mandelbrot == FALSE)
		param->z->real_x += param->zoom / 4;
	if (keycode == 4 && param->mandelbrot == FALSE)
		param->z->imaginary_y += param->zoom / 4;
	return (0);
}
